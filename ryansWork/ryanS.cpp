...
void clock_physics(int)
{
	...
	{	
		case 0:
			...
			//cout << "Game Mode Selected is: " << gameModes[] << endl;
		...
		case 1:
			...
			//cout << "Game Mode Selected is: " << select << endl;
			seconds = (bigHand -= (handIncrement / 75.0));
			if(seconds == -255)
			{
				level = 2;
		...
		default:
			seconds = (bigHand -= (handIncrement / 10000.0));
			if(seconds == -255)
			{
				level = 2;
				break;
...
//THIS IS WHERE REALLY OLD COLD STARTS
 ...
 //TO DO:
 //MAKE KEY --> KEVIN GOT IT
 //MAKE CHAOS LEVEL? --> GONNA HAVE TO
 //ASSIGN TIME TO OTHER LEVELS --> NEED ASSISTANCE
        }
    }
